...
#include <franka_aisl_controllers/cartesian_impedance_controller.h>
...
#include <franka_aisl_controllers/pseudo_inversion.h>

namespace franka_aisl_controllers {
...
bool CartesianImpedanceController::init(hardware_interface::RobotHW* robot_hw,
  ...
  dynamic_server_compliance_param_ = std::make_unique<
      dynamic_reconfigure::Server<franka_aisl_controllers::compliance_paramConfig>>(
...
void CartesianImpedanceController::complianceParamCallback(
    franka_aisl_controllers::compliance_paramConfig& config,
    uint32_t /*level*/) {
...
PLUGINLIB_EXPORT_CLASS(franka_aisl_controllers::CartesianImpedanceController,
